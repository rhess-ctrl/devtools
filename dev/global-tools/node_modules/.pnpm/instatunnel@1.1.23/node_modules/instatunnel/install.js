...
async function setupBinary() {
    ...
    log('   instatunnel 3000                         # Expose localhost:3000 over HTTPS', 'reset');
    log('   instatunnel 3000 --subdomain myapp       # Keep a stable URL for demos/webhooks', 'reset');
    log('   it 3000                                  # Short alias', 'reset');
    log('', 'reset');
    log('🧩 Webhook + MCP examples:', 'cyan');
    log('   instatunnel webhook init --provider stripe --port 4242 --path /webhooks/stripe', 'reset');
    log('   instatunnel 8787 --mcp --transport v2    # Streaming MCP tunnel (Pro/Business)', 'reset');
    log('   instatunnel --help                        # See all commands and flags', 'reset');
    log('', 'reset');
    log('🌟 Why InstaTunnel:', 'yellow');
    log('   ✓ Fast local HTTPS tunnels with stable subdomains', 'green');
    log('   ✓ Built-in webhook helper flow (Stripe/GitHub/Shopify/Twilio/PayPal)', 'green');
    log('   ✓ MCP support with v1 compatibility and v2 streaming transport', 'green');
    log('   ✓ Designed for daily dev, QA, and integration workflows', 'green');
    log('', 'reset');
    log('🔗 Website: https://instatunnel.my', 'yellow');
    log('📚 Docs: https://instatunnel.my/docs', 'yellow');
    log('🧪 Webhook Guides: https://instatunnel.my/docs/webhooks', 'yellow');
    log('🛟 Support: support@instatunnel.my', 'yellow');
